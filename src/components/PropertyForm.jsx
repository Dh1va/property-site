...
const PropertyForm = ({ onSave, editingProperty, cancelEdit }) => {
  ...
  useEffect(() => {
    if (editingProperty) {
      setFormData({
        ...
        totalPrice: editingProperty.totalPrice || "",
        squareMeters: editingProperty.squareMeters || "",
        zip: editingProperty.zip || "",
        place: editingProperty.place || "",
        rooms: editingProperty.rooms || "",
        bathrooms: editingProperty.bathrooms || "",
        pool: editingProperty.pool || false,
        parking: editingProperty.parking || false,
        garden: editingProperty.garden || false,
  ...
  const handleSubmit = async (e) => {
    ...
    for (const key in formData) {
      ...
      if (key === "amenities") {
        data.append(key, formData[key].split(",").map((a) => a.trim()));
      } else {
