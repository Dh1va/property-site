...
export default function EnquiryFormPanel({
  ...
  const IconPhone = () => (
    ...
    >
      <path
        d="M22 16.92V21a1 1 0 01-1.11 1 19.86 19.86 0 01-8.63-3.07 19.5 19.5 0 01-6-6A19.86 19.86 0 012 3.11 1 1 0 013 2h4.09a1 1 0 01.95.68l1.2 3.6a1 1 0 01-.24 1L7.7 9.7a12 12 0 005.6 5.6l1.4-1.4a1 1 0 011-.24l3.6 1.2a1 1 0 01.68.95z"
        strokeWidth="1.2"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
  ...
  const IconMail = () => (
    ...
    >
      <path
        d="M3 8l7 5 7-5M21 8v8a2 2 0 01-2 2H5a2 2 0 01-2-2V8"
        strokeWidth="1.2"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
  ...
  return (
    <div className="rounded-2xl">
      <div className="bg-gradient-to-br from-gray-900 to-gray-800 text-white rounded-2xl shadow-lg p-4 sm:p-5">
